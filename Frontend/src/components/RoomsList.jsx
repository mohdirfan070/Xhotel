...
function RoomsList() {
  ...
  let getData = async () => {
    await axios.get("https://xhotel-lo9z.onrender.com/api/rooms").then((response) => {
    ...
    document.getElementById("my_modal_4").showModal();
      ...
      let addCustomer = async()=>{
        ...
        if(inpData.name=="" || inpData.mobileNumber==91 || inpData.idNumber=="" ){
          ...
          setResponse2(true);
          try{
          await axios.post('https://xhotel-lo9z.onrender.com/api/addcustomer', { inpData}).then((response)=>{
            reset();
            getData();
            // setInpData({
            //   name:"",
